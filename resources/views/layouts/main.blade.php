    ...
    <section id="nav-container" @if ($background == null) class="bg-darkgray" @endif>
        <nav class="bg-dark nav-transparent navbar navbar-expand-lg">
            <div class="col-12 col-xl-10 py-3 container-fluid">
                ...
                <button class="navbar-toggler border-0" style="box-shadow: none;" type="button"
                ...
                <div class="justify-content-end collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="d-flex align-items-center justify-content-end navbar-nav mb-2 mb-lg-0 gap-4">
                        ...
                        @auth
                            ...
                            <li class="nav-item"><button
                                    class="login-link hvr-rectangle-out px-2 py-1 rounded-pill text-light text-decoration-none bg-transparent border-blueultra">{{ auth()->user()->username }}</button>
                            </li>
                        @endauth
                    </ul>
                </div>
